  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Dark overlay - left side (70% dark) */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent z-10" />
        
        {/* Light overlay - right side (subtle) */}
        <div className="absolute inset-0 bg-gradient-to-l from-white/10 via-transparent to-transparent z-10" />
        
        {/* Diagonal gradient split for smooth transition */}
        <div 
          className="absolute inset-0 z-10"
          style={{
            background: 'linear-gradient(135deg, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.3) 40%, rgba(255,255,255,0.05) 60%, rgba(255,255,255,0.1) 100%)'
          }}
        />
      </div>
